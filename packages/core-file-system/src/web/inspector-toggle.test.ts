...
test('create record sits at the right of the toolbar with a blue label', () => {
  ...
  assert.doesNotMatch(css, /fsdb-check-rail/)
  assert.doesNotMatch(css, /\.fsdb-page \.tasks-table-wrap\{[^}]*padding-left:var\(--fsdb-check-gutter\)/)
  assert.match(css, /\.fsdb-page \.tasks-table-wrap\{[^}]*overflow:visible/)
  ...
  assert.doesNotMatch(browser, /fsdb-check-rail/)
  assert.match(browser, /col.key === titleColKey \? <RowCheck ids=\{pickableIds\} \/> : null/)
