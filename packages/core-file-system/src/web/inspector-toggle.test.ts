...
test('create record sits at the right of the toolbar with a blue label', () => {
  ...
  assert.match(css, /\.fsdb-row-check\{[^}]*left:calc\(var\(--fsdb-check-gutter\) \* -1\)/)
  assert.match(css, /\.fsdb-row-check\{[^}]*z-index:12/)
  ...
  assert.match(css, /\.fsdb-row-check \.fsdb-boolbox\{[^}]*border-color:var\(--dsw-label-2\)/)
