...
.fsdb-page .fsdb-col-menu{max-height:min(70vh,480px);overflow:hidden}
.fsdb-page .fsdb-col-menu-list{flex:1 1 auto;min-height:0;overflow:auto;display:flex;flex-direction:column;gap:4px}
.fsdb-page .fsdb-col-menu-subhead{flex:none;padding:8px 8px 2px;font-size:12px;font-weight:600;color:var(--dsw-label-3)}
