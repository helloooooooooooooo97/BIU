...
@keyframes page-agent-edit-fade{
  0%,55%{color:#c4554d;background:color-mix(in srgb,#f9c5d1 72%,transparent)}
  100%{color:inherit;background:transparent}
}
.page-agent-edit{color:#c4554d;background:color-mix(in srgb,#f9c5d1 72%,transparent);border-radius:2px;animation:page-agent-edit-fade 8s ease forwards}
.page-editor .page-agent-edit,.page-editor .page-agent-edit *{color:#c4554d}
.page-source .page-agent-edit{color:#c4554d;background:color-mix(in srgb,#f9c5d1 72%,transparent);border-radius:2px;animation:page-agent-edit-fade 8s ease forwards}
