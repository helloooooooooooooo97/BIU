...
.page-bubble{z-index:80;display:flex;align-items:center;gap:2px;padding:3px;background:var(--dsw-sidebar);border:1px solid var(--dsw-border);box-shadow:0 8px 24px rgba(0,0,0,.16);border-radius:8px;overflow:hidden}
.page-slash{position:fixed;z-index:10000;width:324px;max-height:min(70vh,420px);padding:6px;display:flex;flex-direction:column;gap:2px;overflow-x:hidden;overflow-y:auto;overscroll-behavior:contain;background:var(--dsw-sidebar);border:1px solid var(--dsw-border);box-shadow:0 8px 24px rgba(0,0,0,.16);border-radius:8px}
.page-slash-empty{padding:6px 8px;color:var(--dsw-label-3);font-size:12px;font-weight:600}
