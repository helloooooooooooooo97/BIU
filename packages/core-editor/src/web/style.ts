...
.page-editor .tiptap span.mention,.page-editor .tiptap span[data-type=mention]{border-radius:4px;padding:0 .18em;background:color-mix(in srgb,var(--dsw-business) 14%,transparent);color:var(--dsw-business);text-decoration:none;cursor:pointer}
