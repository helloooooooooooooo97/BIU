...
.page-editor .tiptap span.mention,.page-editor .tiptap span[data-type=mention]{display:inline-flex;align-items:center;gap:3px;border-radius:4px;padding:0 .22em 0 .12em;background:color-mix(in srgb,var(--dsw-business) 14%,transparent);color:var(--dsw-business);text-decoration:none;cursor:pointer;vertical-align:baseline;line-height:1.35}
.page-editor .tiptap span[data-type=mention] .mention-icon,.page-slash .mention-kind-icon{flex:none;width:12px;height:12px;color:currentColor}
.page-slash .mention-kind-icon{width:14px;height:14px;color:var(--dsw-label-2)}
